...
uiNamespace setVariable [ "current_garage", ( _markerName ) ];
BIS_fnc_garage_data	= [
	//CARS
	[FWK_FriendlyLightArray, FWK_FriendlySupportArray],
	//ARMOR
	[FWK_FriendlyArtilleryArray, FWK_FriendlyHeavyArray, FWK_FriendlyAntiAirArray],        
	//HELICOPTERS
    [FWK_FriendlyHeloArray, FWK_FriendlyGunshipArray],
	//PLANES
    [FWK_FriendlyAirArray],
	//NAVAL
    [FWK_FriendlyBoatArray],
	//STATICS
	[FWK_FriendlyStaticArray]
];
_fullVersion = missionNamespace getVariable [ "BIS_fnc_garage_data", false ];
...
{ deleteVehicle _x; } forEach nearestObjects [ getMarkerPos ( _markerName ), [ "AllVehicles" ], 10 ];
_veh = createVehicle [ "Land_HelipadEmpty_F", getMarkerPos ( _markerName ), [], 0, "CAN_COLLIDE" ];
uiNamespace setVariable [ "garage_pad", _veh ];
missionNamespace setVariable [ "BIS_fnc_garage_data", [ true, 0, false, [ false ] ] call bis_fnc_param ];
